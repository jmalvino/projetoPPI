<%-- 
    Document   : index
    Created on : 20/03/2019, 13:15:38
    Author     : kamyr
--%>
...
<html lang='br'>
    ...
    <body>
        <h1 style ="color: white; position: absolute; left: 39%;
                " >Seja bem vindo, Professor!</h1>
        <section><div class="wrap">
                <img class="plus" src="../imagens/seta.png"  alt="plus" />
            </div>
            <div class="content">
                <a href=""><img style ="color: white;"src="" alt="Visualizar Turmas"/></a><br><br>
                <a href=""><img style ="color: white;" src="" alt="Visualizar alunos matriculados da turma"/></a><br><br>
                <a href=""><img style ="color: white;" src="" alt="Visualizar Disciplinas"/></a><br><br>
                <a href=""><img style ="color: white;" src="" alt="Lançar notas para aluno"/></a><br><br>
            </div>
