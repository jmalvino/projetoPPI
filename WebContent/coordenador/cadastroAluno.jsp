<%@page import="br.edu.fafic.dao.AlunoDao"%>
<%@page import="br.edu.fafic.model.Aluno"%>
...
<%-- 				<td><%=pessoa.getPerfil()%></td> --%>
				<td><a
					href="atualizaProfessorAluno.jsp?id_pessoa=<%=aluno.getCodAluno()%>"><img
						src="../imagens/edit.png" /></a></td>
				<td><a href="javascript://"
					onclick="excluir(<%=aluno.getCodAluno()%>, '<%=aluno.getNome()%>')"><img
