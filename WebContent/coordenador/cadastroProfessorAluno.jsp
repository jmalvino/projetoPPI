...
<link rel="mask-icon" type=""
	...
	color="#111" />
<link rel="canonical" href="https://codepen.io/libajunior/pen/PqNrXR" />
		...
		<div
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Cadastro Professor</h3>
				</div>
				<div class="panel-body">
					<form role="form">
						...
						<input type="hidden" value="cadastrar" name="param" /> <input
							type="submit" value="enviar" class="btn btn-info btn-block"
							onclick="validaform();" />
	...
	<div class="panel panel-primary">
		<table class="table table-striped table-condensed">
			...
			<tr>
				...
				<td><%=diretor.getSexo()%></td>
				<td><%=diretor.getCpf()%></td>
				<%-- 				<td><%=diretor.getLogradouro()%></td> --%>
				<%-- 				<td><%=diretor.getNumero()%></td> --%>
				<%-- 				<td><%=diretor.getBairro()%></td> --%>
				<%-- 				<td><%=diretor.getComplemento()%></td> --%>
				<%-- 				<td><%=diretor.getCidade()%></td> --%>
				<%-- 				<td><%=diretor.getCep()%></td> --%>
				<td><%=diretor.getTelefone()%></td>
				<td><%=diretor.getEmail()%></td>
				<%-- 				<td><%=diretor.getUsuario()%></td> --%>
				<!-- 				<td>*****</td> -->
				<%-- 				<td><%=diretor.getPerfil()%></td> --%>
				<td><a
					href="atualizaProfessorAluno.jsp?id_pessoa=<%=diretor.getCodDiretor()%>"><img
						src="../imagens/edit.png" /></a></td>
				<td><a href="javascript://"
					onclick="excluir(<%=diretor.getCodDiretor()%>, '<%=diretor.getNome()%>')"><img
		...
		<input type="button" value="Voltar" class="btn btn-info btn-block"
			onClick="javascript:location.href='indexCoordenador.jsp'">
	</div>
