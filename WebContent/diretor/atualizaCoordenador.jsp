...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Atualiza Coordenador</title>
</head>
<body>
	<%
	...
	<form name="atualizar" action="/UserServlets/cadCoordenador"
		method="post">
		<div
...
<%-- 										value="<%=pessoa.getUsuario()%>"> --%>
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 							<div class="col-xs-6 col-sm-6 col-md-6"> -->
<!-- 								<div class="form-group"> -->
<!-- 									<input type="password" name="senha" -->
<%-- 										class="form-control input-sm" value="<%=pessoa.getSenha()%>"> --%>
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
